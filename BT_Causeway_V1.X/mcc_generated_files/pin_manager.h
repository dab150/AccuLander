...
/**
  ...
  @Example
    <code>
    // Set RA1 high (1)
    Channel_BATT_LVL_SetHigh();
    </code>

*/
#define Channel_BATT_LVL_SetHigh()          _LATA1 = 1
/**
  @Summary
  ...
  @Example
    <code>
    // Set RA1 low (0)
    Channel_BATT_LVL_SetLow();
    </code>

*/
#define Channel_BATT_LVL_SetLow()           _LATA1 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RA1
    Channel_BATT_LVL_SetToggle();
    </code>

*/
#define Channel_BATT_LVL_Toggle()           _LATA1 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RA1
    postValue = Channel_BATT_LVL_GetValue();
    </code>

*/
#define Channel_BATT_LVL_GetValue()         _RA1
/**
  @Summary
  ...
  @Example
    ...
    Channel_BATT_LVL_SetDigitalInput();
    </code>

*/
#define Channel_BATT_LVL_SetDigitalInput()  _TRISA1 = 1
/**
  @Summary
  ...
  @Example
    ...
    Channel_BATT_LVL_SetDigitalOutput();
    </code>

*/
#define Channel_BATT_LVL_SetDigitalOutput() _TRISA1 = 0
/**
  @Summary
...
*/
#define BATT_LVL_EN_SetHigh()          _LATA7 = 1
/**
  @Summary
...
*/
#define BATT_LVL_EN_SetLow()           _LATA7 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RA7
    BATT_LVL_EN_SetToggle();
    </code>

*/
#define BATT_LVL_EN_Toggle()           _LATA7 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RA7
    postValue = BATT_LVL_EN_GetValue();
    </code>

*/
#define BATT_LVL_EN_GetValue()         _RA7
/**
  @Summary
  ...
  @Example
    ...
    BATT_LVL_EN_SetDigitalInput();
    </code>

*/
#define BATT_LVL_EN_SetDigitalInput()  _TRISA7 = 1
/**
  @Summary
  ...
  @Example
    ...
    BATT_LVL_EN_SetDigitalOutput();
    </code>

*/
#define BATT_LVL_EN_SetDigitalOutput() _TRISA7 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Set RA8 high (1)
    SS_BAROMETER_SetHigh();
    </code>

*/
#define SS_BAROMETER_SetHigh()          _LATA8 = 1
/**
  @Summary
...
*/
#define SS_BAROMETER_SetLow()           _LATA8 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RA8
    SS_BAROMETER_SetToggle();
    </code>

*/
#define SS_BAROMETER_Toggle()           _LATA8 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RA8
    postValue = SS_BAROMETER_GetValue();
    </code>

*/
#define SS_BAROMETER_GetValue()         _RA8
/**
  @Summary
  ...
  @Example
    ...
    SS_BAROMETER_SetDigitalInput();
    </code>

*/
#define SS_BAROMETER_SetDigitalInput()  _TRISA8 = 1
/**
  @Summary
  ...
  @Example
    ...
    SS_BAROMETER_SetDigitalOutput();
    </code>

*/
#define SS_BAROMETER_SetDigitalOutput() _TRISA8 = 0
/**
  @Summary
...
*/
#define RADIO_EN_SetHigh()          _LATA9 = 1
/**
  @Summary
...
*/
#define RADIO_EN_SetLow()           _LATA9 = 0
/**
  @Summary
...
*/
#define RADIO_EN_Toggle()           _LATA9 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RA9
    postValue = RADIO_EN_GetValue();
    </code>

*/
#define RADIO_EN_GetValue()         _RA9
/**
  @Summary
  ...
  @Example
    ...
    RADIO_EN_SetDigitalInput();
    </code>

*/
#define RADIO_EN_SetDigitalInput()  _TRISA9 = 1
/**
  @Summary
  ...
  @Example
    ...
    RADIO_EN_SetDigitalOutput();
    </code>

*/
#define RADIO_EN_SetDigitalOutput() _TRISA9 = 0
/**
  @Summary
...
*/
#define CHRG_SetDigitalInput()  _TRISA10 = 1
/**
  @Summary
...
*/
#define CHRG_SetDigitalOutput() _TRISA10 = 0
/**
  @Summary
...
/**
  ...
  @Example
    ...
    // Read RB4
    postValue = USB_NOT_DETECTED_GetValue();
    </code>

*/
#define USB_NOT_DETECTED_GetValue()         _RB4
/**
  @Summary
...
*/
#define LED_YELLOW_SetHigh()          _LATB6 = 1
/**
  @Summary
...
*/
#define LED_YELLOW_SetLow()           _LATB6 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RB6
    LED_YELLOW_SetToggle();
    </code>

*/
#define LED_YELLOW_Toggle()           _LATB6 ^= 1
/**
  @Summary
...
*/
#define LED_YELLOW_GetValue()         _RB6
/**
  @Summary
...
*/
#define LED_YELLOW_SetDigitalInput()  _TRISB6 = 1
/**
  @Summary
...
*/
#define LED_YELLOW_SetDigitalOutput() _TRISB6 = 0
/**
  @Summary
...
*/
#define LED_RED_SetHigh()          _LATB7 = 1
/**
  @Summary
...
*/
#define LED_RED_SetLow()           _LATB7 = 0
/**
  @Summary
...
*/
#define LED_RED_Toggle()           _LATB7 ^= 1
/**
  @Summary
...
*/
#define LED_RED_SetDigitalInput()  _TRISB7 = 1
/**
  @Summary
...
*/
#define LED_RED_SetDigitalOutput() _TRISB7 = 0
/**
  @Summary
...
*/
#define LED_GREEN_SetHigh()          _LATB8 = 1
/**
  @Summary
...
*/
#define LED_GREEN_SetLow()           _LATB8 = 0
/**
  @Summary
...
*/
#define LED_GREEN_Toggle()           _LATB8 ^= 1
/**
  @Summary
...
*/
#define LED_GREEN_GetValue()         _RB8
/**
  @Summary
...
*/
#define LED_GREEN_SetDigitalInput()  _TRISB8 = 1
/**
  @Summary
...
*/
#define LED_GREEN_SetDigitalOutput() _TRISB8 = 0
/**
  @Summary
...
*/
#define U3RX_SetDigitalInput()  _TRISB10 = 1
/**
  @Summary
...
*/
#define U3RX_SetDigitalOutput() _TRISB10 = 0
/**
  @Summary
...
*/
#define U3TX_SetDigitalInput()  _TRISB11 = 1
/**
  @Summary
...
*/
#define U3TX_SetDigitalOutput() _TRISB11 = 0
/**
  @Summary
...
/**
  ...
  @Example
    ...
    // Read RB14
    postValue = U4RX_GetValue();
    </code>

*/
#define U4RX_GetValue()         _RB14
/**
  @Summary
  ...
  @Example
    ...
    U4RX_SetDigitalInput();
    </code>

*/
#define U4RX_SetDigitalInput()  _TRISB14 = 1
/**
  @Summary
  ...
  @Example
    ...
    U4RX_SetDigitalOutput();
    </code>

*/
#define U4RX_SetDigitalOutput() _TRISB14 = 0
/**
  @Summary
...
/**
  ...
  @Example
    ...
    // Read RB15
    postValue = U4TX_GetValue();
    </code>

*/
#define U4TX_GetValue()         _RB15
/**
  @Summary
  ...
  @Example
    ...
    U4TX_SetDigitalInput();
    </code>

*/
#define U4TX_SetDigitalInput()  _TRISB15 = 1
/**
  @Summary
  ...
  @Example
    ...
    U4TX_SetDigitalOutput();
    </code>

*/
#define U4TX_SetDigitalOutput() _TRISB15 = 0
/**
  @Summary
...
*/
#define BT_RESET_SetHigh()          _LATC3 = 1
/**
  @Summary
...
*/
#define BT_RESET_SetLow()           _LATC3 = 0
/**
  @Summary
...
*/
#define BT_RESET_Toggle()           _LATC3 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RC3
    postValue = BT_RESET_GetValue();
    </code>

*/
#define BT_RESET_GetValue()         _RC3
/**
  @Summary
  ...
  @Example
    ...
    BT_RESET_SetDigitalInput();
    </code>

*/
#define BT_RESET_SetDigitalInput()  _TRISC3 = 1
/**
  @Summary
  ...
  @Example
    ...
    BT_RESET_SetDigitalOutput();
    </code>

*/
#define BT_RESET_SetDigitalOutput() _TRISC3 = 0
/**
  @Summary
...
*/
#define U1RX_SetDigitalInput()  _TRISC6 = 1
/**
  @Summary
...
*/
#define U1RX_SetDigitalOutput() _TRISC6 = 0
/**
  @Summary
...
*/
#define U2TX_SetDigitalInput()  _TRISC7 = 1
/**
  @Summary
...
*/
#define U2TX_SetDigitalOutput() _TRISC7 = 0
/**
  @Summary
...
*/
#define U2RX_SetDigitalInput()  _TRISC8 = 1
/**
  @Summary
...
*/
#define U2RX_SetDigitalOutput() _TRISC8 = 0
/**
  @Summary
...
*/
#define GPS_ON_SetHigh()          _LATC9 = 1
/**
  @Summary
...
/**
  ...
  @Example
    ...
    // Read RC9
    postValue = GPS_ON_GetValue();
    </code>

*/
#define GPS_ON_GetValue()         _RC9
/**
  @Summary
  ...
  @Example
    ...
    GPS_ON_SetDigitalInput();
    </code>

*/
#define GPS_ON_SetDigitalInput()  _TRISC9 = 1
/**
  @Summary
  ...
  @Example
    ...
    GPS_ON_SetDigitalOutput();
    </code>

*/
#define GPS_ON_SetDigitalOutput() _TRISC9 = 0
