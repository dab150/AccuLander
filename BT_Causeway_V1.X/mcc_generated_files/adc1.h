...
typedef enum 
{
    ...
    ADC1_CHANNEL_CTMU =  0x0E,
    ADC1_CHANNEL_CTMU_TEMPERATURE_SENSOR_INPUT =  0x0D,
    ADC1_CHANNEL_BATT_LVL =  0x01
} ADC1_CHANNEL;
...
typedef enum
{
    ...
    DRV_ADC1_CHANNEL_CTMU =  0x0E,
    DRV_ADC1_CHANNEL_CTMU_TEMPERATURE_SENSOR_INPUT =  0x0D,
    DRV_ADC1_CHANNEL_BATT_LVL =  0x01
}DRV_ADC1_CHANNEL;
/**
