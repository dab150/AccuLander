...
{
    // ADSIDL disabled; ASAM disabled; FORM Absolute decimal result, unsigned, right-justified; DMABM disabled; MODE12 disabled; ADON disabled; DONE disabled; SAMP disabled; SSRC Clearing sample bit ends sampling and starts conversion; DMAEN disabled; 
   ...
   AD1CON2 = 0x0000;
    ...
    // ADRC FOSC/2; PUMPEN disabled; SAMC 0; EXTSAM disabled; ADCS 0; 
   ...
   AD1CHS = 0x0000;
    ...
    // CSS3 disabled; CSS4 disabled; CSS5 disabled; CSS6 disabled; CSS7 disabled; CSS9 disabled; CSS10 disabled; CSS11 disabled; CSS12 disabled; CSS0 disabled; CSS13 disabled; CSS2 disabled; CSS14 disabled; CSS1 disabled; 

   AD1CSSL = 0x0000;

    // CSS29 disabled; CSS27 disabled; CSS28 disabled; CSS31 disabled; CSS30 disabled; 

   AD1CSSH = 0x0000;

    // VBGEN disabled; VBG2EN disabled; 
